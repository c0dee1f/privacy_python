...
print(f"\nNever mind, the dinner table shan't arrive in time!\n")

print(f"So sorry, {guest_list.pop()}, but your invite has been rescinded.")
print(f"So sorry, {guest_list.pop()}, but your invite has been rescinded.")
print(f"So sorry, {guest_list.pop()}, but your invite has been rescinded.")
print(f"So sorry, {guest_list.pop()}, but your invite has been rescinded.")
print(f"Congrats, {guest_list[0]}, you made the cut!")
print(f"Congrats, {guest_list[1]}, you made the cut!")
